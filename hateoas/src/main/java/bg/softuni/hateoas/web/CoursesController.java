...
public class CoursesController {
  ...
  private final bg.softuni.hateoas.repository.CourseRepository courseRepository;
  private final ModelMapper modelMapper;

  public CoursesController(bg.softuni.hateoas.repository.CourseRepository courseRepository,
